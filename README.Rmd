...
The `02_mixedmodels.R` script loads the `longdata.RData` dataset generated in script 01, which is used to create a single multilevel model to test all hypotheses.
...
The `04_validate.R` script performs the same analysis as in script 02, but on the synthetic dataset.
